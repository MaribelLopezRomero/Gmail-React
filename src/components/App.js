...
function App() {
  return (
    ...
    <table className="table">
      <tbody>
        <tr className="cursor-pointer">
          <td><a href="#" className="text--decoration--none">Front Fest</a></td>
          <td><a href="#" className="text--decoration--none">Entradas ya a la venta</a></td>
          <td><a href="#" className="text--decoration--none">15:27</a></td>
        ...
        <tr className="cursor-pointer">
          <td><a href="#" className="text--decoration--none">GitHub</a></td>
          <td><a href="#" className="text--decoration--none">Adalab/project-promo-i Local store #23</a></td>
          <td><a href="#" className="text--decoration--none">13:51</a></td>
          <td className="text-align-right">
            <button className="form__btn fas fa-trash"></button>
          </td>
        </tr>
        ...
        <tr className="cursor-pointer">
          <td><a href="#" className="text--decoration--none">Node Weekly</a></td>
          <td><a href="#" className="text--decoration--none">Node news</a></td>
          <td><a href="#" className="text--decoration--none">20:41</a></td>
          <td className="text-align-right">
            <button className="form__btn fas fa-trash"></button>
          </td>
        </tr>
    ...
    <div>
      ...
      <p>
        FrontFest es un evento anual y sin ánimo de lucro.
        Está organizado y gestionado por un equipo de voluntarios y
        voluntarias que pertenecen a la comunidad de desarrollo
        frontend. Celebrado por primera vez en 2017, pretende ser
        un punto de encuentro a nivel nacional, principalmente en
